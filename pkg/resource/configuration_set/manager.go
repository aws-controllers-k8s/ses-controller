...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=configurationsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=configurationsets/status,verbs=get;update;patch
